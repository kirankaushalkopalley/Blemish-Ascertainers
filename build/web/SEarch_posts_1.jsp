            ...
            <div class="span8 main-listing">
                ...
                <article class="format-standard type-post hentry clearfix">
                    ...
                    <header class="clearfix">
                        ...
                        <%
                            int search = Integer.parseInt(request.getParameter("post"));
                        %><h3 style="color: red">Category : <q style="color:blue;"><%=search%></q></h3><%
                            ResultSet rs = j.ClassName.get_Search_Results_cat1(search);
                            if (rs.next()) {
                                rs.previous();
                                while (rs.next()) {
                        %>
