...
<div class="page-container">
        ...
        <article class="format-standard type-post hentry clearfix">
          ...
          <header class="clearfix">
            ...
            <%
              ...
              ResultSet rs = j.ClassName.get_POST_Data(session.getAttribute("emailid").toString());
 ...
 <div class="post-meta clearfix">
              ...
              <span class="like-count"><a href="DeletePost.jsp?id=<%=rs.getInt("Post_id")%>">Delete</a></span>
